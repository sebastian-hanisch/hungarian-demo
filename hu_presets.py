...
SETTING_SPECS = {
    ...
    "view_radio": SettingSpec("view", _choice(C.VIEW_LABELS), C.DEFAULT_VIEW),
...
PRESET_KEYS = {"net": "net_select", "view": "view_radio", "n": "n_slider", "m": "m_slider", "reach": "reach_slider", "ballung": "ballung_slider", "seed": "seed_input"}
